    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            if (model.cart_quantity == "0") {
                // Removes add and remove buttons
                holder.itemView.ib_remove_cart_item.visibility = View.GONE
                holder.itemView.ib_add_cart_item.visibility = View.GONE

                // Adds Out of stock text
            ...
            holder.itemView.ib_remove_cart_item.setOnClickListener {
                ...
                // If item quantity is 1, it will remove the item from the cart
                if (model.cart_quantity == "1") {
                    ...
                    // Decrements cart_quantity and converts it back to String
            ...
            holder.itemView.ib_add_cart_item.setOnClickListener {
                ...
                // If cart quantity is not greater than the stock quantity
                if (cartQuantity < model.stock_quantity.toInt()) {

                    val itemHashMap = HashMap<String, Any>()

                    // Increments cart_quantity and converts it back to String
                    itemHashMap[Constants.CART_QUANTITY] = (cartQuantity + 1).toString()
                    ...
                    // Updates the cart and return new hash map
                    FirestoreClass().updateMyCart(context, model.id, itemHashMap)
                } else {
                    if (context is CartListActivity) {
