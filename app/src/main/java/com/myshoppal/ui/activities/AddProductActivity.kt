...
class AddProductActivity : BaseActivity(), View.OnClickListener {
    ...
    // Variable for URI of a selected image from phone storage.
    private var mSelectedImageFileUri: Uri? = null

    // Variable for uploaded product image URL from the cloud
        ...
        if (v != null) {
            when (v.id) {
                ...
                R.id.iv_add_update_product -> {
                    ...
                    // Checks if app has permission to access user's external storage
                ...
                R.id.btn_submit -> {
                    if (validateProductDetails()) {
                        uploadProductImage()
                        //showErrorSnackBar("All Good", false)
                    }
                }
            }
        }
    ...
    // A function for actionBar Setup. (BACK BUTTON)
